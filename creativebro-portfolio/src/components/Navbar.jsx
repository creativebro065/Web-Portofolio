            ...
            <div className="max-w-7xl mx-auto flex justify-between items-center">
                ...
                <div className="flex items-center gap-2 sm:gap-4">
                    ...
                    <button
                        ...
                        className="bg-white text-brutalDark font-black text-[10px] sm:text-xs px-2 sm:px-3 py-1 sm:py-2 border-2 border-brutalDark shadow-brutal hover:bg-brutalAmber hover:text-brutalDark transition-all cursor-pointer uppercase"
